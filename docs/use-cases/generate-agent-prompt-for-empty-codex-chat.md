...
without writing the role prompt manually. Agentic Router generates a
...
4. Agentic Router returns a ready-to-paste prompt and suggested catalog metadata
   for that role.
...
register the new agent in Agentic Router.
