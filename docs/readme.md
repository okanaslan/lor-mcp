...
- `feature-specs/`: feature specifications, added as major features are
  defined.
...
- Add detailed use cases under `use-cases/` and link them from related feature
  specs.
- Add technical design discussions under `tech-specs/` when implementation
  choices need their own source of truth.
